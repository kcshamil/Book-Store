  ...
  return (
    <div>
        ...
        <div className="flex justify-end mt-5">
            <button className="bg-gray-600 text-whie p-2 rounded me-2 hover:bg-white hover:text-gray-400">RESET</button>
            <button className="bg-blue-600 text-white p-2 rounded  hover:bg-white hover:text-blue-400">ADD BOOK</button>
        </div>
        </div>
    </div>
  )

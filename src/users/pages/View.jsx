            ...
            <div className="bg-white rounded-2xl md:w-250 w-100">
              ...
              <div className="relative p-5">
                ...
                <div className="md:flex flex-wrap my-4 justify-center">
                  <img className='md:w-75 w-25 md:me-2 mb-3 md:mb-0'  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTBRTiJIVrtNKzhImdDm-wWXoepi-2KWurOig&s" alt="book" />
